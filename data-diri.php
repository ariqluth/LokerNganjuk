  ...
  <form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="Nama" class="form-control" name="cv_nama" placeholder="Masukkan Nama Lengkap" required>
      </div>
      <div class="form-group">
        <label>Tempat Lahir</label>
        <input type="text" class="form-control" name="cv_tempat_lahir" placeholder="Masukkan Tempat Lahir" required>
      </div>
      <div class="form-group">
        <label>Tanggal Lahir</label>
        <input type="date" class="form-control" name="cv_tanggal_lahir" placeholder="Masukkan Tanggal Lahir" required>
      </div>
      <div class="form-group">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="cv_tinggi_badan" placeholder="Masukkan tinggi Badan dalam satuan cm" required>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="cv_berat_badan" placeholder="Masukkan berat badan dalam satuan kg" required>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <label>Alamat</label>
        <input type="text" class="form-control" name="cv_alamat" placeholder="Masukkan Alamat" required>
      </div>
      <div class="form-group">
        <label>Nomor Hp</label>
        <input type="text" class="form-control" name="cv_hp" placeholder="Masukkan Nomor HP yang Bisa Dihubungi" required>
      </div>
      <div class="form-group">
        <label>Status</label><br>
        <input type="text" class="form-control" name="cv_status" placeholder="Status saat ini" required>
      </div>
      <div class="form-group">
        <label>Email</label>
        <input type="text" class="form-control" name="cv_email" placeholder="Masukkan Email" required>
      </div>

      <div class="form-group">
        <label>Deskripsi Diri</label>
        <textarea name="cv_deskripsi_diri" cols="30" rows="5" class="form-control" required></textarea>
      </div>

      <div class="form-group">
        <label for="cv_foto">Foto</label>
        <input type="file" class="form-control" name="cv_foto" id="cv_foto" onchange="validateImageFile(this)" required>
      </div>
