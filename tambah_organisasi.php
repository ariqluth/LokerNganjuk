        ...
        <div class="row">
          <div class="col-8">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="save_organisasi.php" method="post">
                  ...
                  <table id="data-table">
                      ...
                      <tr>
                          <td><input type="text" class="form-control" name="nama_organisasi[]" /></td>
                          <td><input type="text" class="form-control" name="jabatan_organisasi[]" /></td>
                          <td><input type="text" class="form-control" name="tahun_organisasi[]" /></td>
                      </tr>
                  </table>
                  <br>
                  <div class="form-group">
                    <button type="button" class="btn btn-primary" onclick="addRow()">Tambah Data Organisasi</button>
...
<script>
        function addRow() {
            ...
            cell1.innerHTML = '<input type="text" class="form-control" name="nama_organisasi[]" />';
            cell2.innerHTML = '<input type="text" class="form-control" name="jabatan_organisasi[]" />';
            cell3.innerHTML = '<input type="text" class="form-control" name="tahun_organisasi[]" />';
